...
# vehicles_formatted = json.dumps(vehicles, indent=2)
# print(vehicles_formatted)
# exit()

# iterate through the busses that are on the specified route
for bus in vehicles:
    ...
    for eta in arrival_estimates:
        ...
        print("Day of Week: " + get_weekday(current_datetime.weekday()))
